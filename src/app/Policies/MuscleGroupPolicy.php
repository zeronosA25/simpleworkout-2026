...
class MuscleGroupPolicy
{
    ...
    {
        return $user->can('view_any_muscle::group');
    }
    ...
    {
        return $user->can('view_muscle::group');
    }
    ...
    {
        return $user->can('create_muscle::group');
    }
    ...
    {
        return $user->can('update_muscle::group');
    }
    ...
    {
        return $user->can('delete_muscle::group');
    }
    ...
    {
        return $user->can('delete_any_muscle::group');
    }
     ...
     */
    public function replicate(User $user, MuscleGroup $muscleGroup): bool
    {
